...
const ServicePageMock = () => (
  <div>
    ...
    <div style={{ marginTop: "30px" }}>
      <Link to="date" className="next-btn">
        Avançar para Data →
      </Link>
    </div>
  </div>
...
const DatePageMock = () => (
  <div>
    ...
    <div style={{ display: "flex", gap: "10px" }}>
      ...
      <Link to="../time" className="next-btn">
...
const BookingConfirmMock = () => (
  <div style={{ textAlign: "center", padding: "20px" }}>
    ...
    <p style={{ color: "#666", marginTop: "10px" }}>
      O profissional já recebeu sua solicitação.
    </p>
  </div>
);
...
export default function App() {
  return (
    <>
      {/* Vai ficar somente com os Provider e AppRoutes */}
      <AuthProvider>
        <BusinessProvider>
          <AppRoutes />
        </BusinessProvider>
        ...
        <Route
          ...
          element={
            ...
            >
              ...
              <p>
                Para testar o fluxo do cliente, acesse uma URL com slug.
                Exemplo:
              </p>
              <Link
                to="/barbearia-teste"
